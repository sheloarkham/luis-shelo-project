    ...
    <article className="neo-stat-card">
      ...
      <div className="neo-stat-card__tiles">
        <div className="neo-stat-tile">
          <span className="neo-stat-tile__value" style={{ color }}>{total}</span>
          <span className="neo-stat-tile__label">Total</span>
        </div>
        <div className="neo-stat-tile">
        ...
        <div className="neo-stat-tile">
          <span className="neo-stat-tile__value" style={{ color: '#fde68a' }}>
            {stats.viendo || stats.jugando || stats.leyendo || 0}
          </span>
          <span className="neo-stat-tile__label">En progreso</span>
        </div>
        <div className="neo-stat-tile">
...
const Home = () => {
  ...
  const renderMainContent = () => {
    ...
    const totalItems = allStats.reduce((sum, s) => sum + (s.total || 0), 0)
    ...
    return (
      <Box className="home-page__content" sx={{ px: { xs: 2, md: 3 }, py: { xs: 1, md: 0 } }}>
        <PageHero
          ...
          stats={[
            { value: totalItems, label: 'Total ítems' },
            { value: `${avgProgress}%`, label: 'Progreso medio' },
