...
import { gamesListConfig } from '../config/ocioListConfigs'
...
const GamesList = ({ searchTerm = '' }) => {
  const list = useLocalList({ storageKey: STORAGE_KEY, initialData: initialGamesData })
  return <MediaList searchTerm={searchTerm} config={gamesListConfig} {...list} />
}
