...
const initialSeriesData = [
  { title: "Mayans M.C.", episodes: 50, year: 2018, image: "/series.png", Estado: "Completado" },
  { title: "Percy Jackson and the Olympians", episodes: 8, year: 2023, image: "/series.png", Estado: "Viendo" },
  ...
  { title: "Love, Death & Robots T3", episodes: 9, year: 2022, image: "/series.png", Estado: "Completado" },
  ...
  { title: "The Bear T4", episodes: 10, year: 2025, image: "/series.png", Estado: "Viendo" },
  ...
  { title: "The Penguin", episodes: 8, year: 2024, image: "/series.png", Estado: "Completado" },
  ...
  { title: "Twilight of the Gods", episodes: 8, year: 2024, image: "/series.png", Estado: "Completado" },
  { title: "Dune: Prophecy", episodes: 6, year: 2024, image: "/series.png", Estado: "Completado" },
  { title: "3 Body Problem", episodes: 8, year: 2024, image: "/series.png", Estado: "Completado" },
  { title: "Berlin", episodes: 8, year: 2023, image: "/series.png", Estado: "Completado" },
  { title: "Severance", episodes: 9, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Ted Lasso", episodes: 34, year: 2020, image: "/series.png", Estado: "Completado" },
  { title: "House of the Dragon T2", episodes: 8, year: 2024, image: "/series.png", Estado: "Completado" },
  { title: "Casa de Papel Korea", episodes: 12, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Night Sky", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Resident Evil", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Russian Doll", episodes: 14, year: 2019, image: "/series.png", Estado: "Completado" },
  { title: "Archive 81", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Los Anillos de Poder", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "El Paciente", episodes: 10, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Tokyo Vice", episodes: 18, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Andor T2", episodes: 12, year: 2025, image: "/series.png", Estado: "Pendiente" },
  { title: "Irma Vep", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Under the Banner of Heaven", episodes: 7, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "Pachinko", episodes: 8, year: 2022, image: "/series.png", Estado: "Completado" },
  { title: "For All Mankind", episodes: 40, year: 2019, image: "/series.png", Estado: "Completado" }
]
