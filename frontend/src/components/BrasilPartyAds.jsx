...
const PARTY_ADS = [
  ...
  {
    id: 'dog-bottom-left-1',
    side: 'left',
    top: '72%',
    label: 'PERRO SAMBA',
    subtitle: 'Baila con nosotros',
    rotate: '-3deg',
    delay: 1.05,
  },
  {
    id: 'dog-bottom-right-1',
    side: 'right',
    top: '78%',
    label: 'VIP CANINO',
    subtitle: 'Pase doble gratis*',
    rotate: '4deg',
    delay: 1.25,
  },
  {
    id: 'dog-bottom-left-2',
    side: 'left',
    top: '84%',
    label: 'FESTA DOG',
    subtitle: 'Só na Lapa hoje',
    rotate: '-5deg',
    delay: 1.45,
  },
  {
    id: 'dog-bottom-right-2',
    side: 'right',
    top: '90%',
    label: 'RIO PUPPY',
